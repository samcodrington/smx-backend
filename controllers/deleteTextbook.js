...
exports.deleteTextbook = function(textbookID){
    return Textbook.findByIdAndRemove(textbookID).then(function(resolve){
      if (!resolve)//textbook not found in database
        return Promise.reject("Textbook cannot be found in database");
    });
}
